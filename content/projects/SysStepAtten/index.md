...
{{ <md.centered_img src="sysstepatten_full_device.jpeg"/> }}

{% <md.gallery> %}
    {{ <md.gallery.img src="sysstepatten_full_back.jpeg"/> }}
    {{ <md.gallery.img src="sysstepatten_full.jpeg"/> }}
{% </md.gallery> %}
...
{{ <md.yt src="https://www.youtube-nocookie.com/embed/S0dtfcZPJ4Q"/> }}

## Design

### Attenuator

{{ <md.centered_img src="sysstepatten_sch_atten.svg"/> }}
...
{{ <md.centered_img src="sysstepatten_sch_input.svg"/> }}
...
{{ <md.centered_img src="sysstepatten_connectors.jpeg"/> }}
