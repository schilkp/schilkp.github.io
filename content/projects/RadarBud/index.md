...
{{ <md.centered_img src="projects/RadarBud/radarbud_in_hand.jpeg"/> }}
...
{{ <md.centered_img src="spin_master.svg"/> }}
...
{{ <md.centered_img src="render_lbl_master.svg" width="95%"/> }}
...
{% <md.centered_img src="soli_gestures.jpeg" width="90%"> %}
...
{% <md.gallery> %}
    {% <md.gallery.img src="range_doppler.svg"> %}Example of a raw radar frame, and the generated Range-Doppler map.{% </md.gallery.img> %}
    {% <md.gallery.img src="sequence_doppler.svg"> %}A sequence of Range-Doppler maps, which are the input to the CNN.{% </md.gallery.img> %}
    {% <md.gallery.img src="radar_gesture_nn.svg"> %}Depiction of the two convolutional stages, and final multi-layer perceptron.{% </md.gallery.img> %}
{% </md.gallery> %}
...
{% <md.gallery> %}
    {% <md.gallery.img src="cm.svg"> %}Confusion Matrix of the quantized Network.{% </md.gallery.img> %}
    {% <md.gallery.img src="power_profile.svg"> %}Power profile of an acquisition and inference.{% </md.gallery.img> %}
{% </md.gallery> %}
