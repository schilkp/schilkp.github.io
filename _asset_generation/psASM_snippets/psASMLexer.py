...
class CustomLexer(RegexLexer):
    ...
    tokens = {
        'root': [
            ...
            (r'(AND)|(ANDL)|(OR)|(ORL)|(XOR)|(XORL)|(SHFTR)|(SHFTRL)|(SHFTL)|(SHFTLL)', Keyword.Type),
            (r'(COMPB)|(COMPBC)|(ADD)|(ADDC)|(ADDLA)|(ADDLAC)|(ADDLB)|(ADDLBC)|(NOTA)', Keyword.Type),
            (r'(SUB)|(SUBC)|(SUBL)|(SUBLC)|(LITA)|(LITB)|(CPY)|(SWP)|(SVA)|(SVB)|(LDA)',Keyword.Type),
